...
public class CustomExoMediaPlayer extends BaseInternalPlayer {

    public static final int PLAN_ID = 666;
    private final String TAG = CustomExoMediaPlayer.class.getCanonicalName();
    ...
    public CustomExoMediaPlayer() {
        ...
        mSimpleCache = ExoMediaPlayerCacheConfig.INSTANCE.getSimpleCache();
    ...
    public static void init(Context context) {
        PlayerConfig.addDecoderPlan(new DecoderPlan(
                PLAN_ID,
                CustomExoMediaPlayer.class.getName(),
                "playground_exoplayer"));
        PlayerConfig.setDefaultPlanId(PLAN_ID);
        PlayerLibrary.init(context);
        ExoMediaPlayerCacheConfig.INSTANCE.init();
    }
    ...
    public void setDataSource(DataSource dataSource) {
        ...
        mCacheDataSourceFactory = new CacheDataSourceFactory(mSimpleCache, dataSourceFactory, CacheDataSource.FLAG_IGNORE_CACHE_ON_ERROR);

        // Prepare the player with the source.
        isPreparing = true;

        //create MediaSource
        MediaSource mediaSource = getMediaSource(videoUri, mCacheDataSourceFactory);
