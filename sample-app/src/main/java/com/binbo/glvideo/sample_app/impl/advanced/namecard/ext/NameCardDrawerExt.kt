package com.binbo.glvideo.sample_app.impl.advanced.namecard.ext
...
fun createSloganBitmap(): Bitmap? {
    val rootView = LayoutInflater.from(context).inflate(R.layout.layout_name_card_slogan, null)
    val widthMeasureSpec = View.MeasureSpec.makeMeasureSpec((1 shl 30) - 1, View.MeasureSpec.UNSPECIFIED)
    val heightMeasureSpec = View.MeasureSpec.makeMeasureSpec((1 shl 30) - 1, View.MeasureSpec.UNSPECIFIED)
    rootView.measure(widthMeasureSpec, heightMeasureSpec)
    val measuredWidth = rootView.measuredWidth
...
fun createWatermarkBitmap(): Bitmap? {
    val rootView = LayoutInflater.from(context).inflate(R.layout.layout_name_card_watermark, null)
    val widthMeasureSpec = View.MeasureSpec.makeMeasureSpec((1 shl 30) - 1, View.MeasureSpec.UNSPECIFIED)
    val heightMeasureSpec = View.MeasureSpec.makeMeasureSpec((1 shl 30) - 1, View.MeasureSpec.UNSPECIFIED)
    rootView.measure(widthMeasureSpec, heightMeasureSpec)
    val measuredWidth = rootView.measuredWidth
