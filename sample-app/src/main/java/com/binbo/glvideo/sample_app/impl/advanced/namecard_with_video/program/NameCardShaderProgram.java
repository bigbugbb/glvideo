package com.binbo.glvideo.sample_app.impl.advanced.namecard_with_video.program;
...
public class NameCardShaderProgram extends ShaderProgram {
    ...
    public NameCardShaderProgram(Context context) {
        super(context, R.raw.name_card_vertex_shader, R.raw.name_card_fragment_shader);
