 ...
 * EGL 相关配置
 */
public class RecorderEGLManager {

    private static final String TAG = RecorderEGLManager.class.getSimpleName();
    //
     ...
     */
    public RecorderEGLManager(final EGLContext xShowEglContext, final Object mediaCodecSurface) {
        initRecorderEGL(xShowEglContext, mediaCodecSurface);
    }
     ...
     * @param xShowEglContext
     */
    private void initRecorderEGL(final EGLContext xShowEglContext, final Object mediaCodecSurface) {
    ...
    public int setPresentationTime(long pts) {
        //
        boolean result = eglPresentationTimeANDROID(mEglDisplay, mEglSurface, pts);
        //
        if (!result) {
