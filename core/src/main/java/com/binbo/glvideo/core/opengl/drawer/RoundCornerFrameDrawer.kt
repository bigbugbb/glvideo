...
class RoundCornerFrameDrawer : Drawer() {
    private var textureProgram: RCTextureShaderProgram? = null
    ...
    override fun onWorldCreated() {
        textureProgram = RCTextureShaderProgram(context)
        frame = Frame()
    }
    ...
    override fun draw() {
        ...
        textureProgram?.setUniforms(projectionMatrix, textureId, frame?.cornerRadius ?: 0f, frame?.borderSize ?: 0f, viewportWidth, viewportHeight)
